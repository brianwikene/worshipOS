...
// Define what your Tenant input looks like
...
// 🔹 Derive the real context type from the initializer
type TenantStore = ReturnType<typeof initTenant>;

// 2. The Getter (Call this in any component to get the data)
export function useTenant() {
	const context = getContext<TenantStore>(TENANT_KEY);
	if (!context) {
