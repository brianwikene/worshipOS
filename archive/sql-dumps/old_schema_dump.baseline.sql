...
DROP POLICY IF EXISTS "Users can read own permissions" ON public.app_users;
DROP POLICY IF EXISTS "Care Notes: Viewable by Creator or Permission" ON public.care_notes;
DROP POLICY IF EXISTS "Care Notes: Insertable by Author" ON public.care_notes;
DROP POLICY IF EXISTS "Care Cases: Viewable by Creator or Permission" ON public.care_cases;
ALTER TABLE IF EXISTS ONLY public.template_sections DROP CONSTRAINT IF EXISTS template_sections_updated_by_fkey;
ALTER TABLE IF EXISTS ONLY public.template_sections DROP CONSTRAINT IF EXISTS template_sections_template_id_fkey;
ALTER TABLE IF EXISTS ONLY public.template_sections DROP CONSTRAINT IF EXISTS template_sections_ministry_area_id_fkey;
ALTER TABLE IF EXISTS ONLY public.template_sections DROP CONSTRAINT IF EXISTS template_sections_created_by_fkey;
ALTER TABLE IF EXISTS ONLY public.template_sections DROP CONSTRAINT IF EXISTS template_sections_church_id_fkey;
ALTER TABLE IF EXISTS ONLY public.teams DROP CONSTRAINT IF EXISTS teams_church_id_fkey;
ALTER TABLE IF EXISTS ONLY public.songs DROP CONSTRAINT IF EXISTS songs_org_id_fkey;
ALTER TABLE IF EXISTS ONLY public.song_variants DROP CONSTRAINT IF EXISTS song_variants_song_id_fkey;
ALTER TABLE IF EXISTS ONLY public.song_variants DROP CONSTRAINT IF EXISTS song_variants_org_id_fkey;
ALTER TABLE IF EXISTS ONLY public.song_sections DROP CONSTRAINT IF EXISTS song_sections_song_id_fkey;
ALTER TABLE IF EXISTS ONLY public.song_sections DROP CONSTRAINT IF EXISTS song_sections_org_id_fkey;
ALTER TABLE IF EXISTS ONLY public.song_arrangements DROP CONSTRAINT IF EXISTS song_arrangements_song_id_fkey;
ALTER TABLE IF EXISTS ONLY public.song_arrangements DROP CONSTRAINT IF EXISTS song_arrangements_org_id_fkey;
ALTER TABLE IF EXISTS ONLY public.song_arrangements DROP CONSTRAINT IF EXISTS song_arrangements_created_by_fkey;
ALTER TABLE IF EXISTS ONLY public.service_instances DROP CONSTRAINT IF EXISTS services_org_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_types DROP CONSTRAINT IF EXISTS service_types_updated_by_fkey;
ALTER TABLE IF EXISTS ONLY public.service_types DROP CONSTRAINT IF EXISTS service_types_default_template_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_types DROP CONSTRAINT IF EXISTS service_types_created_by_fkey;
ALTER TABLE IF EXISTS ONLY public.service_types DROP CONSTRAINT IF EXISTS service_types_context_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_types DROP CONSTRAINT IF EXISTS service_types_church_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_types DROP CONSTRAINT IF EXISTS service_types_archived_by_fkey;
ALTER TABLE IF EXISTS ONLY public.service_templates DROP CONSTRAINT IF EXISTS service_templates_updated_by_fkey;
ALTER TABLE IF EXISTS ONLY public.service_templates DROP CONSTRAINT IF EXISTS service_templates_parent_template_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_templates DROP CONSTRAINT IF EXISTS service_templates_org_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_templates DROP CONSTRAINT IF EXISTS service_templates_created_by_fkey;
ALTER TABLE IF EXISTS ONLY public.service_templates DROP CONSTRAINT IF EXISTS service_templates_context_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_templates DROP CONSTRAINT IF EXISTS service_templates_archived_by_fkey;
ALTER TABLE IF EXISTS ONLY public.service_team_assignments DROP CONSTRAINT IF EXISTS service_team_assignments_role_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_team_assignments DROP CONSTRAINT IF EXISTS service_team_assignments_person_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_team_assignments DROP CONSTRAINT IF EXISTS service_team_assignments_org_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_role_requirements DROP CONSTRAINT IF EXISTS service_role_requirements_role_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_role_requirements DROP CONSTRAINT IF EXISTS service_role_requirements_context_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_items DROP CONSTRAINT IF EXISTS service_items_song_variant_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_items DROP CONSTRAINT IF EXISTS service_items_org_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_instances DROP CONSTRAINT IF EXISTS service_instances_updated_by_fkey;
ALTER TABLE IF EXISTS ONLY public.service_instances DROP CONSTRAINT IF EXISTS service_instances_template_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_instances DROP CONSTRAINT IF EXISTS service_instances_service_type_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_instances DROP CONSTRAINT IF EXISTS service_instances_locked_by_fkey;
ALTER TABLE IF EXISTS ONLY public.service_instances DROP CONSTRAINT IF EXISTS service_instances_group_tenant_fk;
ALTER TABLE IF EXISTS ONLY public.service_instances DROP CONSTRAINT IF EXISTS service_instances_created_by_fkey;
ALTER TABLE IF EXISTS ONLY public.service_instances DROP CONSTRAINT IF EXISTS service_instances_completed_by_fkey;
ALTER TABLE IF EXISTS ONLY public.service_instances DROP CONSTRAINT IF EXISTS service_instances_campus_tenant_fk;
ALTER TABLE IF EXISTS ONLY public.service_instances DROP CONSTRAINT IF EXISTS service_instances_archived_by_fkey;
ALTER TABLE IF EXISTS ONLY public.service_instance_songs DROP CONSTRAINT IF EXISTS service_instance_songs_updated_by_fkey;
ALTER TABLE IF EXISTS ONLY public.service_instance_songs DROP CONSTRAINT IF EXISTS service_instance_songs_song_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_instance_songs DROP CONSTRAINT IF EXISTS service_instance_songs_service_instance_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_instance_songs DROP CONSTRAINT IF EXISTS service_instance_songs_section_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_instance_songs DROP CONSTRAINT IF EXISTS service_instance_songs_created_by_fkey;
ALTER TABLE IF EXISTS ONLY public.service_instance_songs DROP CONSTRAINT IF EXISTS service_instance_songs_arrangement_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_instance_sections DROP CONSTRAINT IF EXISTS service_instance_sections_updated_by_fkey;
ALTER TABLE IF EXISTS ONLY public.service_instance_sections DROP CONSTRAINT IF EXISTS service_instance_sections_template_section_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_instance_sections DROP CONSTRAINT IF EXISTS service_instance_sections_service_instance_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_instance_sections DROP CONSTRAINT IF EXISTS service_instance_sections_ministry_area_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_instance_sections DROP CONSTRAINT IF EXISTS service_instance_sections_marked_ready_by_fkey;
ALTER TABLE IF EXISTS ONLY public.service_instance_sections DROP CONSTRAINT IF EXISTS service_instance_sections_created_by_fkey;
ALTER TABLE IF EXISTS ONLY public.service_instance_sections DROP CONSTRAINT IF EXISTS service_instance_sections_church_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_instance_sections DROP CONSTRAINT IF EXISTS service_instance_sections_approved_by_fkey;
ALTER TABLE IF EXISTS ONLY public.service_groups DROP CONSTRAINT IF EXISTS service_groups_org_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_groups DROP CONSTRAINT IF EXISTS service_groups_context_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_audit_log DROP CONSTRAINT IF EXISTS service_audit_log_church_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_audit_log DROP CONSTRAINT IF EXISTS service_audit_log_changed_by_fkey;
ALTER TABLE IF EXISTS ONLY public.service_audit_log DROP CONSTRAINT IF EXISTS service_audit_log_amendment_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_assignments DROP CONSTRAINT IF EXISTS service_assignments_service_instance_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_assignments DROP CONSTRAINT IF EXISTS service_assignments_role_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_assignments DROP CONSTRAINT IF EXISTS service_assignments_person_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_assignments DROP CONSTRAINT IF EXISTS service_assignments_org_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_assignments DROP CONSTRAINT IF EXISTS service_assignments_assigned_by_fkey;
ALTER TABLE IF EXISTS ONLY public.service_amendments DROP CONSTRAINT IF EXISTS service_amendments_verified_by_fkey;
ALTER TABLE IF EXISTS ONLY public.service_amendments DROP CONSTRAINT IF EXISTS service_amendments_service_instance_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_amendments DROP CONSTRAINT IF EXISTS service_amendments_recorded_by_fkey;
ALTER TABLE IF EXISTS ONLY public.service_amendments DROP CONSTRAINT IF EXISTS service_amendments_church_id_fkey;
ALTER TABLE IF EXISTS ONLY public.roles DROP CONSTRAINT IF EXISTS roles_team_id_fkey;
ALTER TABLE IF EXISTS ONLY public.roles DROP CONSTRAINT IF EXISTS roles_org_id_fkey;
ALTER TABLE IF EXISTS ONLY public.person_role_capabilities DROP CONSTRAINT IF EXISTS person_role_capabilities_role_id_fkey;
ALTER TABLE IF EXISTS ONLY public.person_role_capabilities DROP CONSTRAINT IF EXISTS person_role_capabilities_person_id_fkey;
ALTER TABLE IF EXISTS ONLY public.person_aliases DROP CONSTRAINT IF EXISTS person_aliases_person_id_fkey;
ALTER TABLE IF EXISTS ONLY public.person_aliases DROP CONSTRAINT IF EXISTS person_aliases_church_id_fkey;
ALTER TABLE IF EXISTS ONLY public.people DROP CONSTRAINT IF EXISTS people_org_id_fkey;
ALTER TABLE IF EXISTS ONLY public.people DROP CONSTRAINT IF EXISTS people_canonical_id_fkey;
ALTER TABLE IF EXISTS ONLY public.notification_preferences DROP CONSTRAINT IF EXISTS notification_preferences_person_id_fkey;
ALTER TABLE IF EXISTS ONLY public.notification_preferences DROP CONSTRAINT IF EXISTS notification_preferences_org_id_fkey;
ALTER TABLE IF EXISTS ONLY public.ministry_areas DROP CONSTRAINT IF EXISTS ministry_areas_updated_by_fkey;
ALTER TABLE IF EXISTS ONLY public.ministry_areas DROP CONSTRAINT IF EXISTS ministry_areas_parent_id_fkey;
ALTER TABLE IF EXISTS ONLY public.ministry_areas DROP CONSTRAINT IF EXISTS ministry_areas_created_by_fkey;
ALTER TABLE IF EXISTS ONLY public.ministry_areas DROP CONSTRAINT IF EXISTS ministry_areas_church_id_fkey;
ALTER TABLE IF EXISTS ONLY public.ministry_areas DROP CONSTRAINT IF EXISTS ministry_areas_archived_by_fkey;
ALTER TABLE IF EXISTS ONLY public.merge_events DROP CONSTRAINT IF EXISTS merge_events_undone_by_fkey;
ALTER TABLE IF EXISTS ONLY public.merge_events DROP CONSTRAINT IF EXISTS merge_events_survivor_id_fkey;
ALTER TABLE IF EXISTS ONLY public.merge_events DROP CONSTRAINT IF EXISTS merge_events_performed_by_fkey;
ALTER TABLE IF EXISTS ONLY public.merge_events DROP CONSTRAINT IF EXISTS merge_events_identity_link_id_fkey;
ALTER TABLE IF EXISTS ONLY public.merge_events DROP CONSTRAINT IF EXISTS merge_events_church_id_fkey;
ALTER TABLE IF EXISTS ONLY public.identity_links DROP CONSTRAINT IF EXISTS identity_links_reviewed_by_fkey;
ALTER TABLE IF EXISTS ONLY public.identity_links DROP CONSTRAINT IF EXISTS identity_links_person_b_id_fkey;
ALTER TABLE IF EXISTS ONLY public.identity_links DROP CONSTRAINT IF EXISTS identity_links_person_a_id_fkey;
ALTER TABLE IF EXISTS ONLY public.identity_links DROP CONSTRAINT IF EXISTS identity_links_church_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_team_assignments DROP CONSTRAINT IF EXISTS fk_sta_strict_tenancy;
ALTER TABLE IF EXISTS ONLY public.service_items DROP CONSTRAINT IF EXISTS fk_sitems_strict_tenancy;
ALTER TABLE IF EXISTS ONLY public.service_instance_sections DROP CONSTRAINT IF EXISTS fk_sisec_strict_tenancy;
ALTER TABLE IF EXISTS ONLY public.service_instance_songs DROP CONSTRAINT IF EXISTS fk_sis_strict_tenancy;
ALTER TABLE IF EXISTS ONLY public.service_team_assignments DROP CONSTRAINT IF EXISTS fk_service_team_assignments_instance;
ALTER TABLE IF EXISTS ONLY public.service_items DROP CONSTRAINT IF EXISTS fk_service_items_instance;
ALTER TABLE IF EXISTS ONLY public.person_role_capabilities DROP CONSTRAINT IF EXISTS fk_prc_verified_by_person;
ALTER TABLE IF EXISTS ONLY public.family_members DROP CONSTRAINT IF EXISTS family_members_person_id_fkey;
ALTER TABLE IF EXISTS ONLY public.family_members DROP CONSTRAINT IF EXISTS family_members_org_id_fkey;
ALTER TABLE IF EXISTS ONLY public.family_members DROP CONSTRAINT IF EXISTS family_members_family_id_fkey;
ALTER TABLE IF EXISTS ONLY public.families DROP CONSTRAINT IF EXISTS families_primary_address_id_fkey;
ALTER TABLE IF EXISTS ONLY public.families DROP CONSTRAINT IF EXISTS families_org_id_fkey;
ALTER TABLE IF EXISTS ONLY public.contexts DROP CONSTRAINT IF EXISTS contexts_org_id_fkey;
ALTER TABLE IF EXISTS ONLY public.contact_methods DROP CONSTRAINT IF EXISTS contact_methods_person_id_fkey;
ALTER TABLE IF EXISTS ONLY public.contact_methods DROP CONSTRAINT IF EXISTS contact_methods_org_id_fkey;
ALTER TABLE IF EXISTS ONLY public.care_notes DROP CONSTRAINT IF EXISTS care_notes_person_id_fkey;
ALTER TABLE IF EXISTS ONLY public.care_notes DROP CONSTRAINT IF EXISTS care_notes_author_id_fkey;
ALTER TABLE IF EXISTS ONLY public.care_cases DROP CONSTRAINT IF EXISTS care_cases_person_id_fkey;
ALTER TABLE IF EXISTS ONLY public.care_cases DROP CONSTRAINT IF EXISTS care_cases_created_by_fkey;
ALTER TABLE IF EXISTS ONLY public.care_cases DROP CONSTRAINT IF EXISTS care_cases_church_id_fkey;
ALTER TABLE IF EXISTS ONLY public.campuses DROP CONSTRAINT IF EXISTS campuses_org_id_fkey;
ALTER TABLE IF EXISTS ONLY public.campuses DROP CONSTRAINT IF EXISTS campuses_address_id_fkey;
ALTER TABLE IF EXISTS ONLY public.assignment_notifications DROP CONSTRAINT IF EXISTS assignment_notifications_person_id_fkey;
ALTER TABLE IF EXISTS ONLY public.assignment_notifications DROP CONSTRAINT IF EXISTS assignment_notifications_org_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.app_users DROP CONSTRAINT IF EXISTS app_users_person_id_fkey;
ALTER TABLE IF EXISTS ONLY public.app_users DROP CONSTRAINT IF EXISTS app_users_id_fkey;
ALTER TABLE IF EXISTS ONLY public.app_users DROP CONSTRAINT IF EXISTS app_users_church_id_fkey;
ALTER TABLE IF EXISTS ONLY public.addresses DROP CONSTRAINT IF EXISTS addresses_person_id_fkey;
ALTER TABLE IF EXISTS ONLY public.addresses DROP CONSTRAINT IF EXISTS addresses_org_id_fkey;
ALTER TABLE IF EXISTS ONLY public.addresses DROP CONSTRAINT IF EXISTS addresses_family_id_fkey;
ALTER TABLE IF EXISTS ONLY public.addresses DROP CONSTRAINT IF EXISTS addresses_campus_id_fkey;
DROP TRIGGER IF EXISTS trigger_auto_deactivate_family_member ON public.family_members;
DROP TRIGGER IF EXISTS trg_compute_display_name ON public.people;
DROP TRIGGER IF EXISTS songs_updated_at ON public.songs;
DROP TRIGGER IF EXISTS song_arrangements_updated_at ON public.song_arrangements;
DROP TRIGGER IF EXISTS identity_links_updated_at ON public.identity_links;
DROP INDEX IF EXISTS public.idx_template_sections_template;
DROP INDEX IF EXISTS public.idx_template_sections_ministry;
DROP INDEX IF EXISTS public.idx_teams_church;
DROP INDEX IF EXISTS public.idx_teams_active;
DROP INDEX IF EXISTS public.idx_song_variants_type;
DROP INDEX IF EXISTS public.idx_song_variants_song;
DROP INDEX IF EXISTS public.idx_song_variants_default;
DROP INDEX IF EXISTS public.idx_song_variants_dates;
DROP INDEX IF EXISTS public.idx_song_variants_context;
DROP INDEX IF EXISTS public.idx_song_sections_song;
DROP INDEX IF EXISTS public.idx_song_sections_seasonal;
DROP INDEX IF EXISTS public.idx_song_sections_org;
DROP INDEX IF EXISTS public.idx_song_arrangements_song;
DROP INDEX IF EXISTS public.idx_song_arrangements_org;
DROP INDEX IF EXISTS public.idx_song_arrangements_default;
DROP INDEX IF EXISTS public.idx_song_arrangements_church;
DROP INDEX IF EXISTS public.idx_sis_church_instance;
DROP INDEX IF EXISTS public.idx_service_types_context;
DROP INDEX IF EXISTS public.idx_service_types_church;
DROP INDEX IF EXISTS public.idx_service_types_active;
DROP INDEX IF EXISTS public.idx_service_templates_org;
DROP INDEX IF EXISTS public.idx_service_templates_default;
DROP INDEX IF EXISTS public.idx_service_templates_context;
DROP INDEX IF EXISTS public.idx_service_team_assignments_role;
DROP INDEX IF EXISTS public.idx_service_team_assignments_person;
DROP INDEX IF EXISTS public.idx_service_team_assignments_instance;
DROP INDEX IF EXISTS public.idx_service_role_requirements_context;
DROP INDEX IF EXISTS public.idx_service_items_instance_sort;
DROP INDEX IF EXISTS public.idx_service_instances_status;
DROP INDEX IF EXISTS public.idx_service_instances_service_type;
DROP INDEX IF EXISTS public.idx_service_instances_org_date;
DROP INDEX IF EXISTS public.idx_service_instances_locked;
DROP INDEX IF EXISTS public.idx_service_instances_group;
DROP INDEX IF EXISTS public.idx_service_instances_church_date;
DROP INDEX IF EXISTS public.idx_service_instances_campus;
DROP INDEX IF EXISTS public.idx_service_instance_songs_song;
DROP INDEX IF EXISTS public.idx_service_instance_songs_instance;
DROP INDEX IF EXISTS public.idx_service_instance_songs_arrangement;
DROP INDEX IF EXISTS public.idx_service_groups_org_date;
DROP INDEX IF EXISTS public.idx_service_groups_church_date;
DROP INDEX IF EXISTS public.idx_service_assignments_status;
DROP INDEX IF EXISTS public.idx_service_assignments_role;
DROP INDEX IF EXISTS public.idx_service_assignments_person;
DROP INDEX IF EXISTS public.idx_service_assignments_instance;
DROP INDEX IF EXISTS public.idx_roles_team;
DROP INDEX IF EXISTS public.idx_roles_org;
DROP INDEX IF EXISTS public.idx_roles_church;
DROP INDEX IF EXISTS public.idx_roles_active;
DROP INDEX IF EXISTS public.idx_person_role_capabilities_role;
DROP INDEX IF EXISTS public.idx_person_role_capabilities_person;
DROP INDEX IF EXISTS public.idx_person_aliases_person;
DROP INDEX IF EXISTS public.idx_person_aliases_name;
DROP INDEX IF EXISTS public.idx_person_aliases_church;
DROP INDEX IF EXISTS public.idx_person_aliases_active;
DROP INDEX IF EXISTS public.idx_people_org;
DROP INDEX IF EXISTS public.idx_people_merged;
DROP INDEX IF EXISTS public.idx_people_canonical;
DROP INDEX IF EXISTS public.idx_people_active;
DROP INDEX IF EXISTS public.idx_notification_prefs_person;
DROP INDEX IF EXISTS public.idx_ministry_areas_parent;
DROP INDEX IF EXISTS public.idx_ministry_areas_church;
DROP INDEX IF EXISTS public.idx_ministry_areas_active;
DROP INDEX IF EXISTS public.idx_merge_events_undoable;
DROP INDEX IF EXISTS public.idx_merge_events_survivor;
DROP INDEX IF EXISTS public.idx_merge_events_recent;
DROP INDEX IF EXISTS public.idx_merge_events_merged;
DROP INDEX IF EXISTS public.idx_merge_events_church;
DROP INDEX IF EXISTS public.idx_instance_songs_section;
DROP INDEX IF EXISTS public.idx_instance_songs_performed;
DROP INDEX IF EXISTS public.idx_instance_songs_ccli_pending;
DROP INDEX IF EXISTS public.idx_instance_sections_status;
DROP INDEX IF EXISTS public.idx_instance_sections_service;
DROP INDEX IF EXISTS public.idx_instance_sections_ministry;
DROP INDEX IF EXISTS public.idx_identity_links_review;
DROP INDEX IF EXISTS public.idx_identity_links_person_b;
DROP INDEX IF EXISTS public.idx_identity_links_person_a;
DROP INDEX IF EXISTS public.idx_identity_links_pending;
DROP INDEX IF EXISTS public.idx_identity_links_church;
DROP INDEX IF EXISTS public.idx_family_members_relationship;
DROP INDEX IF EXISTS public.idx_family_members_person;
DROP INDEX IF EXISTS public.idx_family_members_family;
DROP INDEX IF EXISTS public.idx_family_members_active;
DROP INDEX IF EXISTS public.idx_families_org;
DROP INDEX IF EXISTS public.idx_families_active;
DROP INDEX IF EXISTS public.idx_contacts_person;
DROP INDEX IF EXISTS public.idx_campuses_address_id;
DROP INDEX IF EXISTS public.idx_audit_table_record;
DROP INDEX IF EXISTS public.idx_audit_church_date;
DROP INDEX IF EXISTS public.idx_audit_changed_at;
DROP INDEX IF EXISTS public.idx_assignment_notifications_person;
DROP INDEX IF EXISTS public.idx_assignment_notifications_assignment;
DROP INDEX IF EXISTS public.idx_amendments_type;
DROP INDEX IF EXISTS public.idx_amendments_service;
DROP INDEX IF EXISTS public.idx_amendments_recorded;
DROP INDEX IF EXISTS public.idx_amendments_ccli;
DROP INDEX IF EXISTS public.idx_addresses_person;
DROP INDEX IF EXISTS public.idx_addresses_family;
DROP INDEX IF EXISTS public.idx_addresses_church_id;
DROP INDEX IF EXISTS public.idx_addresses_church;
DROP INDEX IF EXISTS public.idx_addresses_campus;
ALTER TABLE IF EXISTS ONLY public.template_sections DROP CONSTRAINT IF EXISTS unique_template_section_order;
ALTER TABLE IF EXISTS ONLY public.song_arrangements DROP CONSTRAINT IF EXISTS unique_song_arrangement_name;
ALTER TABLE IF EXISTS ONLY public.service_instance_songs DROP CONSTRAINT IF EXISTS unique_service_song_order;
ALTER TABLE IF EXISTS ONLY public.notification_preferences DROP CONSTRAINT IF EXISTS unique_person_notification_prefs;
ALTER TABLE IF EXISTS ONLY public.service_templates DROP CONSTRAINT IF EXISTS unique_org_template_name;
ALTER TABLE IF EXISTS ONLY public.service_instance_sections DROP CONSTRAINT IF EXISTS unique_instance_section_order;
ALTER TABLE IF EXISTS ONLY public.service_instances DROP CONSTRAINT IF EXISTS unique_instance_church_id;
ALTER TABLE IF EXISTS ONLY public.service_types DROP CONSTRAINT IF EXISTS unique_church_service_type;
ALTER TABLE IF EXISTS ONLY public.ministry_areas DROP CONSTRAINT IF EXISTS unique_church_ministry_area;
ALTER TABLE IF EXISTS ONLY public.template_sections DROP CONSTRAINT IF EXISTS template_sections_pkey;
ALTER TABLE IF EXISTS ONLY public.teams DROP CONSTRAINT IF EXISTS teams_pkey;
ALTER TABLE IF EXISTS ONLY public.teams DROP CONSTRAINT IF EXISTS teams_church_id_name_key;
ALTER TABLE IF EXISTS ONLY public.service_role_requirements DROP CONSTRAINT IF EXISTS srr_org_context_role_uniq;
ALTER TABLE IF EXISTS ONLY public.songs DROP CONSTRAINT IF EXISTS songs_pkey;
ALTER TABLE IF EXISTS ONLY public.song_variants DROP CONSTRAINT IF EXISTS song_variants_pkey;
ALTER TABLE IF EXISTS ONLY public.song_sections DROP CONSTRAINT IF EXISTS song_sections_pkey;
ALTER TABLE IF EXISTS ONLY public.song_arrangements DROP CONSTRAINT IF EXISTS song_arrangements_pkey;
ALTER TABLE IF EXISTS ONLY public.service_instances DROP CONSTRAINT IF EXISTS services_pkey;
...
ALTER TABLE IF EXISTS ONLY public.service_team_assignments DROP CONSTRAINT IF EXISTS service_team_assignments_service_id_person_id_role_id_key;
ALTER TABLE IF EXISTS ONLY public.service_team_assignments DROP CONSTRAINT IF EXISTS service_team_assignments_pkey;
ALTER TABLE IF EXISTS ONLY public.service_role_requirements DROP CONSTRAINT IF EXISTS service_role_requirements_pkey;
ALTER TABLE IF EXISTS ONLY public.service_items DROP CONSTRAINT IF EXISTS service_items_pkey;
ALTER TABLE IF EXISTS ONLY public.service_instance_songs DROP CONSTRAINT IF EXISTS service_instance_songs_pkey;
ALTER TABLE IF EXISTS ONLY public.service_instance_sections DROP CONSTRAINT IF EXISTS service_instance_sections_pkey;
ALTER TABLE IF EXISTS ONLY public.service_groups DROP CONSTRAINT IF EXISTS service_groups_pkey;
ALTER TABLE IF EXISTS ONLY public.service_groups DROP CONSTRAINT IF EXISTS service_groups_church_id_id_uniq;
ALTER TABLE IF EXISTS ONLY public.service_audit_log DROP CONSTRAINT IF EXISTS service_audit_log_pkey;
ALTER TABLE IF EXISTS ONLY public.service_assignments DROP CONSTRAINT IF EXISTS service_assignments_pkey;
ALTER TABLE IF EXISTS ONLY public.service_amendments DROP CONSTRAINT IF EXISTS service_amendments_pkey;
ALTER TABLE IF EXISTS ONLY public.schema_migrations DROP CONSTRAINT IF EXISTS schema_migrations_pkey;
ALTER TABLE IF EXISTS ONLY public.service_assignments DROP CONSTRAINT IF EXISTS sa_org_instance_role_person_uniq;
ALTER TABLE IF EXISTS ONLY public.roles DROP CONSTRAINT IF EXISTS roles_pkey;
ALTER TABLE IF EXISTS ONLY public.roles DROP CONSTRAINT IF EXISTS roles_org_id_name_key;
ALTER TABLE IF EXISTS ONLY public.person_role_capabilities DROP CONSTRAINT IF EXISTS prc_org_person_role_uniq;
ALTER TABLE IF EXISTS ONLY public.person_role_capabilities DROP CONSTRAINT IF EXISTS person_role_capabilities_pkey;
ALTER TABLE IF EXISTS ONLY public.person_aliases DROP CONSTRAINT IF EXISTS person_aliases_pkey;
ALTER TABLE IF EXISTS ONLY public.people DROP CONSTRAINT IF EXISTS people_pkey;
ALTER TABLE IF EXISTS ONLY public.churches DROP CONSTRAINT IF EXISTS orgs_pkey;
ALTER TABLE IF EXISTS ONLY public.notification_preferences DROP CONSTRAINT IF EXISTS notification_preferences_pkey;
ALTER TABLE IF EXISTS ONLY public.ministry_areas DROP CONSTRAINT IF EXISTS ministry_areas_pkey;
ALTER TABLE IF EXISTS ONLY public.merge_events DROP CONSTRAINT IF EXISTS merge_events_pkey;
ALTER TABLE IF EXISTS ONLY public.identity_links DROP CONSTRAINT IF EXISTS identity_links_unique;
ALTER TABLE IF EXISTS ONLY public.identity_links DROP CONSTRAINT IF EXISTS identity_links_pkey;
ALTER TABLE IF EXISTS ONLY public.family_members DROP CONSTRAINT IF EXISTS fm_org_family_person_uniq;
...
ALTER TABLE IF EXISTS ONLY public.contexts DROP CONSTRAINT IF EXISTS contexts_org_id_name_key;
ALTER TABLE IF EXISTS ONLY public.contact_methods DROP CONSTRAINT IF EXISTS contact_methods_pkey;
ALTER TABLE IF EXISTS ONLY public.care_notes DROP CONSTRAINT IF EXISTS care_notes_pkey;
ALTER TABLE IF EXISTS ONLY public.care_cases DROP CONSTRAINT IF EXISTS care_cases_pkey;
ALTER TABLE IF EXISTS ONLY public.campuses DROP CONSTRAINT IF EXISTS campuses_pkey;
ALTER TABLE IF EXISTS ONLY public.campuses DROP CONSTRAINT IF EXISTS campuses_org_id_name_key;
ALTER TABLE IF EXISTS ONLY public.campuses DROP CONSTRAINT IF EXISTS campuses_church_id_id_uniq;
...
DROP VIEW IF EXISTS public.v_tend_burnout_signals;
DROP VIEW IF EXISTS public.v_template_summary;
DROP VIEW IF EXISTS public.v_services_display;
DROP VIEW IF EXISTS public.v_service_status_v2;
DROP VIEW IF EXISTS public.v_service_staffing_detail;
DROP VIEW IF EXISTS public.v_service_assignment_summary;
DROP VIEW IF EXISTS public.v_section_ownership;
DROP VIEW IF EXISTS public.v_family_summary;
DROP VIEW IF EXISTS public.v_context_role_requirements;
DROP VIEW IF EXISTS public.v_ccli_report_v2;
DROP TABLE IF EXISTS public.template_sections;
DROP TABLE IF EXISTS public.teams;
DROP TABLE IF EXISTS public.songs;
DROP TABLE IF EXISTS public.song_variants;
DROP TABLE IF EXISTS public.song_sections;
DROP TABLE IF EXISTS public.song_arrangements;
DROP TABLE IF EXISTS public.service_types;
DROP TABLE IF EXISTS public.service_templates;
DROP TABLE IF EXISTS public.service_team_assignments;
DROP TABLE IF EXISTS public.service_role_requirements;
DROP TABLE IF EXISTS public.service_items;
DROP TABLE IF EXISTS public.service_instances;
DROP TABLE IF EXISTS public.service_instance_songs;
DROP TABLE IF EXISTS public.service_instance_sections;
DROP TABLE IF EXISTS public.service_groups;
DROP TABLE IF EXISTS public.service_audit_log;
DROP TABLE IF EXISTS public.service_assignments;
DROP TABLE IF EXISTS public.service_amendments;
DROP TABLE IF EXISTS public.schema_migrations;
DROP TABLE IF EXISTS public.roles;
DROP TABLE IF EXISTS public.person_role_capabilities;
DROP TABLE IF EXISTS public.person_aliases;
DROP TABLE IF EXISTS public.notification_preferences;
DROP TABLE IF EXISTS public.ministry_areas;
DROP TABLE IF EXISTS public.merge_events;
...
DROP TABLE IF EXISTS public.care_cases;
...
DROP FUNCTION IF EXISTS public.save_service_as_template(p_service_instance_id uuid, p_template_name text, p_description text);
DROP FUNCTION IF EXISTS public.record_song_amendment(p_church_id uuid, p_service_instance_id uuid, p_song_instance_id uuid, p_amendment_type text, p_actual_song_id uuid, p_reason text, p_recorded_by uuid);
DROP FUNCTION IF EXISTS public.lock_service_instance(p_service_instance_id uuid, p_locked_by uuid, p_reason text);
DROP FUNCTION IF EXISTS public.is_variant_active(p_variant_id uuid, p_check_date date);
DROP FUNCTION IF EXISTS public.get_service_roster(p_service_instance_id uuid);
DROP FUNCTION IF EXISTS public.get_service_roster(p_service_id integer);
DROP FUNCTION IF EXISTS public.get_family_roster(p_family_id uuid);
DROP FUNCTION IF EXISTS public.get_checkable_children(p_family_id uuid);
DROP FUNCTION IF EXISTS public.copy_service_to_date(p_source_instance_id uuid, p_target_date date, p_target_time time without time zone, p_org_id uuid);
DROP FUNCTION IF EXISTS public.compute_display_name();
DROP FUNCTION IF EXISTS public.complete_service_instance(p_service_instance_id uuid, p_completed_by uuid);
DROP FUNCTION IF EXISTS public.auto_deactivate_family_member();
DROP FUNCTION IF EXISTS auth.uid();
DROP TYPE IF EXISTS public.app_role_type;
...
--
-- Name: app_role_type; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: complete_service_instance(uuid, uuid); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION complete_service_instance(p_service_instance_id uuid, p_completed_by uuid); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: compute_display_name(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: is_variant_active(uuid, date); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION is_variant_active(p_variant_id uuid, p_check_date date); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: lock_service_instance(uuid, uuid, text); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION lock_service_instance(p_service_instance_id uuid, p_locked_by uuid, p_reason text); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: record_song_amendment(uuid, uuid, uuid, text, uuid, text, uuid); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION record_song_amendment(p_church_id uuid, p_service_instance_id uuid, p_song_instance_id uuid, p_amendment_type text, p_actual_song_id uuid, p_reason text, p_recorded_by uuid); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN people.membership_status; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN people.care_notes_enabled; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN people.last_known_attendance; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: active_people; Type: VIEW; Schema: public; Owner: -
--
...
--
-- Name: care_cases; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: merge_events; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: ministry_areas; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: TABLE ministry_areas; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN ministry_areas.name; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN ministry_areas.parent_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN ministry_areas.archived_at; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN roles.body_parts; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: service_amendments; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: TABLE service_amendments; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN service_amendments.ccli_relevant; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN service_amendments.recorded_by; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: TABLE service_audit_log; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: service_instance_sections; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: TABLE service_instance_sections; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN service_instance_sections.actual_start_time; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN service_instance_songs.section_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN service_instance_songs.was_performed; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN service_instance_songs.actual_key; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN service_instance_songs.ccli_reported; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN service_instances.locked_at; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN service_instances.archived_at; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN service_templates.archived_at; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN service_templates.version; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN service_templates.parent_template_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN service_types.recurrence_rule; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN service_types.default_times; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN song_sections.seasonal_tags; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN song_sections.availability; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN song_variants.variant_type; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN song_variants.style_description; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN song_variants.tempo_modifier; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN song_variants.key_modifier; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN song_variants.context_tags; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN song_variants.active_dates; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN song_variants.notes; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN songs.source_format; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN songs.raw_text; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN songs.parsed_json; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: TABLE template_sections; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN template_sections.ministry_area_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN template_sections.ownership_config; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: v_ccli_report_v2; Type: VIEW; Schema: public; Owner: -
--
...
--
-- Name: VIEW v_ccli_report_v2; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: v_section_ownership; Type: VIEW; Schema: public; Owner: -
--
...
--
-- Name: VIEW v_section_ownership; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: v_service_status_v2; Type: VIEW; Schema: public; Owner: -
--
...
--
-- Name: VIEW v_service_status_v2; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: v_tend_burnout_signals; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.v_tend_burnout_signals AS
 SELECT p.id AS person_id,
    p.display_name,
    p.church_id,
    count(sa.id) FILTER (WHERE (sa.service_instance_id IN ( SELECT service_instances.id
           FROM public.service_instances
          WHERE (service_instances.service_date > (CURRENT_DATE - '30 days'::interval))))) AS last_30_days_count,
    max(si.service_date) AS last_served_date,
        CASE
            WHEN (count(sa.id) >= 4) THEN 'high_load'::text
            WHEN (max(si.service_date) < (CURRENT_DATE - '60 days'::interval)) THEN 'disconnected'::text
            ELSE 'healthy'::text
        END AS status_signal
   FROM ((public.people p
     LEFT JOIN public.service_assignments sa ON ((p.id = sa.person_id)))
     LEFT JOIN public.service_instances si ON ((sa.service_instance_id = si.id)))
  WHERE (p.is_active = true)
  GROUP BY p.id, p.display_name, p.church_id;
...
--
-- Name: campuses campuses_church_id_id_uniq; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: care_cases care_cases_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: identity_links identity_links_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: merge_events merge_events_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ministry_areas ministry_areas_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: churches orgs_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_amendments service_amendments_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_groups service_groups_church_id_id_uniq; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_instance_sections service_instance_sections_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: teams teams_church_id_name_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ministry_areas unique_church_ministry_area; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_types unique_church_service_type; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_instances unique_instance_church_id; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_instance_sections unique_instance_section_order; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: template_sections unique_template_section_order; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_addresses_campus; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_addresses_church; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_addresses_church_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_addresses_family; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_amendments_ccli; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_amendments_recorded; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_amendments_service; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_amendments_type; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_audit_church_date; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_campuses_address_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_identity_links_church; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_identity_links_pending; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_identity_links_person_a; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_identity_links_person_b; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_identity_links_review; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_instance_sections_ministry; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_instance_sections_service; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_instance_sections_status; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_instance_songs_ccli_pending; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_instance_songs_performed; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_instance_songs_section; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_merge_events_church; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_merge_events_merged; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_merge_events_recent; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_merge_events_survivor; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_merge_events_undoable; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_ministry_areas_active; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_ministry_areas_church; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_ministry_areas_parent; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_people_canonical; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_people_merged; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_person_aliases_active; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_person_aliases_church; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_person_aliases_name; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_roles_church; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_roles_team; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_service_groups_church_date; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_service_instances_church_date; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_service_instances_locked; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_service_instances_service_type; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_service_types_church; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_service_types_context; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_sis_church_instance; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_song_arrangements_church; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_song_sections_seasonal; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_song_variants_context; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_song_variants_dates; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_song_variants_default; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_song_variants_type; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_teams_church; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_template_sections_ministry; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_template_sections_template; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: identity_links identity_links_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: song_arrangements song_arrangements_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: songs songs_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: people trg_compute_display_name; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: addresses addresses_campus_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: addresses addresses_family_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: app_users app_users_church_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: app_users app_users_person_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: campuses campuses_address_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: care_cases care_cases_church_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: care_cases care_cases_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: care_cases care_cases_person_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.care_cases
    ADD CONSTRAINT care_cases_person_id_fkey FOREIGN KEY (person_id) REFERENCES public.people(id);


--
-- Name: care_notes care_notes_author_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.care_notes
    ADD CONSTRAINT care_notes_author_id_fkey FOREIGN KEY (author_id) REFERENCES public.people(id);


--
-- Name: care_notes care_notes_person_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.care_notes
    ADD CONSTRAINT care_notes_person_id_fkey FOREIGN KEY (person_id) REFERENCES public.people(id);
...
--
-- Name: service_instance_songs fk_sis_strict_tenancy; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_instance_sections fk_sisec_strict_tenancy; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_items fk_sitems_strict_tenancy; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_team_assignments fk_sta_strict_tenancy; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: identity_links identity_links_church_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: identity_links identity_links_person_a_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: identity_links identity_links_person_b_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: identity_links identity_links_reviewed_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: merge_events merge_events_church_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: merge_events merge_events_identity_link_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: merge_events merge_events_performed_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: merge_events merge_events_survivor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: merge_events merge_events_undone_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ministry_areas ministry_areas_archived_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ministry_areas ministry_areas_church_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ministry_areas ministry_areas_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ministry_areas ministry_areas_parent_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ministry_areas ministry_areas_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: people people_canonical_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: person_aliases person_aliases_church_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: roles roles_team_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_amendments service_amendments_church_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_amendments service_amendments_recorded_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_amendments service_amendments_service_instance_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_amendments service_amendments_verified_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_audit_log service_audit_log_amendment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_audit_log service_audit_log_church_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_instance_sections service_instance_sections_approved_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_instance_sections service_instance_sections_church_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_instance_sections service_instance_sections_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_instance_sections service_instance_sections_marked_ready_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_instance_sections service_instance_sections_ministry_area_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_instance_sections service_instance_sections_service_instance_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_instance_sections service_instance_sections_template_section_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_instance_sections service_instance_sections_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_instance_songs service_instance_songs_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_instance_songs service_instance_songs_section_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_instance_songs service_instance_songs_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_instances service_instances_archived_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_instances service_instances_campus_tenant_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_instances service_instances_completed_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_instances service_instances_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_instances service_instances_group_tenant_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_instances service_instances_locked_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_instances service_instances_service_type_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_instances service_instances_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_templates service_templates_archived_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_templates service_templates_parent_template_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_templates service_templates_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_types service_types_archived_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_types service_types_church_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_types service_types_context_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_types service_types_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_types service_types_default_template_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: service_types service_types_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: teams teams_church_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: template_sections template_sections_church_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: template_sections template_sections_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: template_sections template_sections_ministry_area_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: template_sections template_sections_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: care_cases Care Cases: Viewable by Creator or Permission; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Care Cases: Viewable by Creator or Permission" ON public.care_cases FOR SELECT USING (((auth.uid() = created_by) OR (EXISTS ( SELECT 1
   FROM public.app_users
  WHERE ((app_users.id = auth.uid()) AND (app_users.can_view_care_notes = true))))));


--
-- Name: care_notes Care Notes: Insertable by Author; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: care_notes Care Notes: Viewable by Creator or Permission; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: app_users Users can read own permissions; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: care_cases; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.care_cases ENABLE ROW LEVEL SECURITY;

--
-- Name: care_notes; Type: ROW SECURITY; Schema: public; Owner: -
--
