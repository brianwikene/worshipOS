...
<div class="flex flex-col items-center justify-center py-24 text-center px-4">
  ...
  <h2 class="text-xl font-semibold text-[var(--ui-color-text-strong)] mb-2">
    {featureName} is under development.
  </h2>

  <p class="text-[var(--ui-color-text-muted)] max-w-md mx-auto leading-relaxed">
    We are actively building and testing this section. It isn't ready for use yet, and we won't ship it until it meets our standard of quality.
  </p>
