			...
			<form class="modal-form" onsubmit|preventDefault={handleSubmit}>
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<span class="hint">
							ChordPro keeps chords inline, e.g., <code>[C]</code>You are here or
							<code>&#123;c:C&#125;</code>You are here.
						</span>
					</div>
					...
					<div class="form-group">
						...
						/>
						<span class="hint">
							ChordPro format supported (sections, directives, inline chords via [C] or
							&#123;c:C&#125;). Use blank lines between sections.
						</span>
					</div>
