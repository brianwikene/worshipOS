<!-- /ui/src/routes/connections/families/[id]/+page.svelte -->
...
<script lang="ts">
	...
	async function deleteAddress(addressId: string) {
		...
		try {
			await apiFetch(`/api/families/${family.id}/address?address_id=${addressId}`, {
				method: 'DELETE'
			});
			await loadFamily();
		} catch (e: any) {
...
<div class="sys-page sys-page--narrow">
	...
	{:else if error}
		<div class="sys-state sys-state--error">
			<p>Error: {error}</p>
			<button class="sys-btn sys-btn--danger" onclick={loadFamily}>Retry</button>
		</div>
	{:else if family}
		<div class="family-header">
			<div class="header-info">
				...
				<div class="addresses-section">
								...
								<div class="address-item" class:primary={address.is_primary}>
									...
									<div class="address-actions">
										...
										<button
											...
											title="Edit address">✏️</button
										>
										<button
											class="btn-address-action delete"
					...
					{/if}
					<button class="btn-add-address" onclick={() => openAddressModal(null)}>
						+ Add Address
					</button>
				</div>
			</div>
		...
		<div class="members-section">
			<div class="section-header">
				...
				<button class="btn-add-member" onclick={toggleAddMember}>
					...
					{#each activeMembers as member}
						<div class="member-card" class:temporary={member.is_temporary}>
							...
							<div class="member-actions">
								<button
									class="btn-icon"
									onclick={() => togglePrimaryContact(member)}
									title={member.is_primary_contact
