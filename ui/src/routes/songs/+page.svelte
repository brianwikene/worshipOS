            ...
            <a href={`/songs/${song.id}`} class="song-link">
              ...
              <div class="song-info">
                ...
                <div class="song-meta">
                  ...
                  {#if song.key} • Key: {song.key}{/if}
                </div>
              </div>
            </a>

            <div class="card-actions">
              <button class="sys-icon-btn" on:click={(e) => openEditModal(song, e)} title="Edit Details">
                ✏️
              </button>
              <button class="sys-icon-btn sys-icon-btn--danger" on:click={(e) => handleArchive(song, e)} title="Archive">
                🗑️
              </button>
            </div>
          </div>
              ...
              {#each songs as song}
                <tr>
                  ...
                  <td class="col-actions">
                    <button class="sys-icon-btn" on:click={(e) => openEditModal(song, e)}>✏️</button>
                    <button class="sys-icon-btn sys-icon-btn--danger" on:click={(e) => handleArchive(song, e)}>🗑️</button>
                  </td>
                </tr>
              {/each}
            </tbody>
...
<style>
  ...
  .muted { color: var(--sys-muted); font-size: 0.9rem; }
