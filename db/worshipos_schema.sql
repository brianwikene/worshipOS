...
\restrict HmDtAfRbLeQbQybQBC5lB78ayeiYCRVqtjSgeGQbE1jh9M9VGuMJNLe9BtfSbhY
...
--
-- Name: person_role_capabilities person_role_capabilities_person_id_role_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.person_role_capabilities
    ADD CONSTRAINT person_role_capabilities_person_id_role_id_key UNIQUE (person_id, role_id);
...
--
-- Name: service_role_requirements service_role_requirements_context_id_role_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.service_role_requirements
    ADD CONSTRAINT service_role_requirements_context_id_role_id_key UNIQUE (context_id, role_id);
...
--
-- Name: person_role_capabilities_person_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: person_role_capabilities_person_id_idx1; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX person_role_capabilities_person_id_idx1 ON public.person_role_capabilities USING btree (person_id);


--
-- Name: person_role_capabilities_role_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: person_role_capabilities_role_id_idx1; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX person_role_capabilities_role_id_idx1 ON public.person_role_capabilities USING btree (role_id);
...
\unrestrict HmDtAfRbLeQbQybQBC5lB78ayeiYCRVqtjSgeGQbE1jh9M9VGuMJNLe9BtfSbhY
